...
<body class="{{table}}">
    <div class="content">
        ...
        <a href="{{base}}/" class="title"><span><font color="#1DB954">{{info.title}}</span></font>{{info.x-subtitle}}</a>
...
<h1><font color="#1DB954">{{info.title}}</font></h1>
<br/>
<ul class="home">
    {{for:item:menu}}
   <li>
    <h1><a href="{{base}}/{{item}}/list">{{item|humanize}}</a></h1>
    </li>
    {{endfor}}
</ul>
END_OF_HTML;
...
namespace Tqdev\PhpCrudApi\Config {
    ...
    class Config implements ConfigInterface
    {
        private $values = [
            ...
            'debug' => false,
            'basePath' => '',
            'openApiBase' => '{"info":{"title":"REGISTROS PARA BIBLIOTECA","version":"1.0.0"}}',
            'geometrySrid' => 4326,
        ];
        ...
        public function getInfo()
        {
            ...
            if (isset($this->definition['info'])) {
                ...
                if (!isset($info['x-subtitle'])) {
                    $info['x-subtitle'] = 'Darwin Marcano';
                }
            }
            return $info;
        }
